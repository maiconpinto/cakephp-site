...
class PartnersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'order' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => '1', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            'id' => 1,
            'created' => '2018-03-27 12:08:57',
            'modified' => '2018-03-27 12:08:57',
